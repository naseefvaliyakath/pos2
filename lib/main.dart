...
class _MyAppState extends State<MyApp> {
  ...
  Future _printReceiveTest() async {
    ...
    final ByteData data = await rootBundle.load('assets/logo_hotel.png');
    final Uint8List bytesn = data.buffer.asUint8List();
    final imgs.Image? image = decodeImage(bytesn);
    ...
    bytes += generator.text('Product 2');
    bytes += generator.text('Product 1');
    bytes += generator.qrcode('naseef vs',size: QRSize.Size8);
